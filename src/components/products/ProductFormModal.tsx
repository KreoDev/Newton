  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (isEditing && product) {
        await updateDocument("products", product.id, productData, "Product updated successfully")
      } else {
        await createDocument("products", productData, "Product created successfully")
      }
