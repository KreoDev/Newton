      ...
      >
        <div className="bg-white dark:bg-gray-800 rounded-3xl shadow-2xl p-8 md:p-12">
          ...
          <motion.h1
            ...
            className="text-4xl md:text-5xl font-bold text-center mb-4 bg-gradient-to-r from-purple-600 to-pink-600 dark:from-purple-400 dark:to-pink-400 bg-clip-text text-transparent"
          >
            Database Seeder
          </motion.h1>
          ...
          {!isSeeding && progressMessages.length === 0 && (
            ...
            >
              <div className="bg-gradient-to-br from-red-50 to-orange-50 dark:from-red-900/20 dark:to-orange-900/20 rounded-2xl p-6 border border-red-200 dark:border-red-800">
                ...
                <p className="text-sm text-red-700 dark:text-red-300">All existing assets and transporters will be deleted</p>
              </div>
              ...
              <div className="bg-gradient-to-br from-green-50 to-emerald-50 dark:from-green-900/20 dark:to-emerald-900/20 rounded-2xl p-6 border border-green-200 dark:border-green-800">
                ...
                <p className="text-sm text-green-700 dark:text-green-300">Fresh assets and 2 transporters will be added</p>
              </div>
            </motion.div>
          )}
          ...
          {progressMessages.length > 0 && (
            <motion.div
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
              className="mb-8 bg-gray-50 dark:bg-gray-900/50 rounded-2xl p-6 max-h-96 overflow-y-auto"
            >
                ...
                <AnimatePresence>
                  {progressMessages.map((msg, index) => (
                    <motion.div
                      ...
                      className={`flex items-start gap-3 p-3 rounded-xl border ${getStageColor(msg.stage)}`}
                    >
                        ...
                        {msg.progress && (
                          <div className="mt-2">
                            ...
                            <div className="w-full bg-gray-200 dark:bg-gray-700 rounded-full h-2 overflow-hidden">
                              <motion.div
                                initial={{ width: 0 }}
                                animate={{ width: `${(msg.progress.current / msg.progress.total) * 100}%` }}
                                transition={{ duration: 0.5 }}
            ...
            >
              <div className="bg-gradient-to-br from-green-50 to-emerald-50 dark:from-green-900/20 dark:to-emerald-900/20 rounded-2xl p-6 border border-green-200 dark:border-green-800">
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  <div>
                    <h4 className="font-semibold text-green-800 dark:text-green-200 mb-3">Cleared</h4>
                    <div className="space-y-2">
                      <div className="bg-white/50 dark:bg-gray-800/50 rounded-xl p-3">
                        ...
                        <p className="text-2xl font-bold text-green-600 dark:text-green-400">{results.cleared.assets}</p>
                      </div>
                      <div className="bg-white/50 dark:bg-gray-800/50 rounded-xl p-3">
                        <p className="text-xs text-gray-600 dark:text-gray-400">Transporters</p>
                        <p className="text-2xl font-bold text-green-600 dark:text-green-400">{results.cleared.transporters}</p>
                      </div>
                    </div>
                  </div>

                  <div>
                    <h4 className="font-semibold text-green-800 dark:text-green-200 mb-3">Seeded</h4>
                    <div className="space-y-2">
                      <div className="bg-white/50 dark:bg-gray-800/50 rounded-xl p-3">
                        <p className="text-xs text-gray-600 dark:text-gray-400">Assets</p>
                        <p className="text-2xl font-bold text-green-600 dark:text-green-400">{results.seeded.assets}</p>
                      </div>
                      <div className="bg-white/50 dark:bg-gray-800/50 rounded-xl p-3">
                        <p className="text-xs text-gray-600 dark:text-gray-400">Transporters</p>
                        <p className="text-2xl font-bold text-green-600 dark:text-green-400">{results.seeded.transporters}</p>
                      </div>
                    </div>
                  </div>
                </div>
          ...
          {error && !results && (
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
              className="mt-8 bg-gradient-to-br from-red-50 to-orange-50 dark:from-red-900/20 dark:to-orange-900/20 rounded-2xl p-6 border border-red-200 dark:border-red-800"
            >
